      ...
      <Box>
        ...
        <Grid.Col xs={12} sm={6}>
          ...
          <Group position="center" mt="xl">
            ...
            {active >= 5 ? (
              <Button color={"gray"} variant={"outline"} onClick={collectFormData}>
                Complete
              </Button>
              
            ) : (
              <Button color={"gray"} variant={"outline"} onClick={nextStep}>
                Next step
              </Button>
            )}
          </Group>
          ...
          <Grid item xs={12} sm={4}>
              <Box sx={{ padding: "2rem", }}>
                ...
                <Typography>
                  <strong>Portfolio Website:</strong> {formData.portfolio}
                </Typography>
                ...
                {formData.work_history.map((work: any, index: number) => (
                  <div key={index}>
                    ...
                    <Typography>
                      <strong>Company Website:</strong> {work.company_website}
                    </Typography>
                    <Typography>
                      <strong>Employment Type:</strong> {work.employment_type}
                    </Typography>
                    <Typography>
                      <strong>Country:</strong> {work.country}
                    </Typography>
                    <Typography>
                      <strong>City:</strong> {work.city}
                    </Typography>
                    <Typography>
                      <strong>From:</strong> {work.from.toString()}
                    </Typography>
                    <Typography>
                      <strong>To:</strong> {work.to.toString()}
                    </Typography>
                    <Typography>
                      <strong>Current:</strong> {work.current ? "Yes" : "No"}
                    </Typography>
                    <Typography>
                      <strong>Technologies:</strong> {work.tech.join(", ")}
                    </Typography>
                    <Typography>
                      <strong>Description:</strong> {work.desc}
                    </Typography>
                  </div>
                ))}
                ...
                {formData.education.map((edu: any, index: number) => (
                  <div key={index}>
                    ...
                    <Typography>
                      <strong>From:</strong> {edu.from.toString()}
                    </Typography>
                    <Typography>
                      <strong>To:</strong> {edu.to.toString()}
                    </Typography>
                    <Typography>
